...
public class SettingsActivity extends AppCompatActivity {
    private static final String TAG = "org.lrq3000.polycalx.SettingsActivity";
    ...
    public static class SettingsFragment extends PreferenceFragmentCompat {
        ...
        public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
            ...
            findPreference("screenshot_mode").setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                ...
                public boolean onPreferenceChange(Preference preference, Object newSetting) {
                    ...
                    Intent redraw = new Intent("org.lrq3000.polycalx.CHANGE_SOURCE");
            ...
            findPreference("calendar_select").setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                ...
                public boolean onPreferenceChange(Preference preference, Object newVal) {
                    ...
                    Intent redraw = new Intent("org.lrq3000.polycalx.RELOAD_EVENTS");
                    redraw.setPackage(getContext().getPackageName());
                    getContext().sendBroadcast(redraw);
        ...
        public void UpdatePreferences() {
            ...
            DateFormatPref.setEntries(PolyCalXDateFormats.getFormatsReadable() );
            DateFormatPref.setEntryValues(PolyCalXDateFormats.getFormatsParseable() );
            ...
            DateFormatAlldayPref.setEntries(PolyCalXDateFormats.getFormatsReadableAllday() );
            DateFormatAlldayPref.setEntryValues(PolyCalXDateFormats.getFormatsParseableAllday() );
